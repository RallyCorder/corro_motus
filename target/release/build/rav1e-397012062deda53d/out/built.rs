...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/rally/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/rally/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/home/rally/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.86.0 (05f9846f8 2025-03-31)";
#[doc=r#"The output of `/home/rally/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/rally/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
